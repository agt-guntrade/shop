    ...
    <>
      ...
      <ContainerLayout>
        <Field.Text
          name="content"
          defaultValue={`
          Allgemeine Geschäftsbedingungen der Firma AGT Gun Trade GmbH
          ...
          (1) Vorvertragliche Mitteilungen, insbesondere Angebote, Beschreibungen, Kostenvoranschläge und dergleichen von AGT Gun Trade GmbH erfolgen freibleibend und unverbindlich. Die folgenden Regelungen über den Vertragsabschluss, gelten für Bestellungen über unsere Website: www.agt-guntrade.at
          
          (2) Im Falle des Vertragsschlusses kommt der Vertrag mit
          
          AGT Gun Trade GmbH Ressnig 20 9170 Ferlach Telefonnummer: 0650 7201960 E-Mail: office@agt-guntrade.at
          
          sowie
          
          AGT Gun Trade GmbH Wildfellnerstrasse 22/1 4910 Ried im Innkreis Telefonnummer: 0676 6510977 Email: info@agt-guntrade.at
          ...
          Bei Teillieferungen fällt die Pauschale jeweils nur einmal an, wenn nicht anders vor dem Kauf vereinbart. Der Vertrag kommt mit der Absendung der Bestellbestätigung durch AGT Gun Trade GmbH an den Kunden zustande. Diese Auftragsbestätigung ist Grundlage des Vertrages und maßgeblich für Inhalt und Umfang der Lieferung. Bis zu drei Tagen nach Erhalt der Auftragsbestätigung kann der Kunde Änderungen des Vertrages schriftlich mitteilen, andernfalls Inhalt und Umfang der Auftragsbestätigung als angenommen gelten. Etwaige Änderungswünsche werden erst wirksam, wenn Sse von AGT Gun Trade GmbH bestätigt wurden. Spätere Änderungen werden grundsätzlich nicht berücksichtigt. Sollte AGT Gun Trade GmbH dennoch Lieferung nach verspäteten Änderungswünschen des Kunden durchführen, erfolgt dies nur aus Kulanzgründen, ohne dass AGT Gun Trade GmbH dazu verpflichtet ist. Änderungen und Ergänzungen des Kunden zu ihrer Wirksamkeit ausdrücklich der schriftlichen Bestätigung der AGT Gun Trade GmbH.
          ...
          3. Zahlung nach Erhalt der Rechnung ohne weiteren Abzug, wenn nicht auf der Rechnung anders
          
          ausgewiesen ist. (Ausstellungsdatum: Rechnung = Lieferdatum)
          
          Bei Zahlungsverzug werden je nach Mahnstufe, Mahngebühren und Verzugszinsen in Rechnung
          
          gestellt. Verzugszinsen werden zu dem Zeitpunkt aktuellen Zinssatz verrechnet.
          
          Der Käufer verpflichtet sich, alle dem Verkäufer durch Zahlungsverzug entstandenen Kosten der
          ...
          5. Der Rechnungsbetrag ist nach Zugang der Vorausrechnung (nicht die mit der Bestellbestätigung kommt, sondern erst mit den Versandkosten individuell ausgefertigt wird), die alle Angaben für die Überweisung enthält und mit E-Mail verschickt wird, auf das dort angegebene Konto, vorab ohne Abzug, zu überweisen.
          ...
          AGT Gun Trade GmbH Ressnig 20 9170 Ferlach Telefonnummer: 0650 7201960 Email: office@agt-guntrade.at
          ...
          Sie können das Muster-Widerrufsformular oder eine andere eindeutige Erklärung auch auf unserer Webseite:http://www.agt-guntrade.at/withdrawal.php elektronisch ausfüllen und übermitteln.
          ...
          1: Sämtliche Angaben der Lieferdaten seitens AGT Gun Trade GmbH sind unverbindlich. Schadenersatzansprüche des Kunden wegen verspäteter Erfüllung sind ausgeschlossen. Bei Eintritt von Hindernissen, insbesondere aufgrund höherer Gewalt, verlängert sich die Lieferfrist. Hierzu zählen auch Maßnahmen im Rahmen von Arbeitskämpfen, insbesondere Streik und Aussperrung, sowie die Nichterteilung entsprechender Ein-/Ausfuhrgenehmigungen. Die Verlängerung der Lieferfrist gilt auch bei unvorhergesehenen Hindernissen und Umständen bei einem Unterlieferanten. AGT Gun Trade GmbH ist berechtigt, die Herstellung und Lieferung um die Dauer der Behinderung zuzüglich einer angemessenen Anlauffrist hinauszuschieben oder vom Vertrag zurückzutreten. Die ursprünglich von AGT Gun Trade GmbH angegebenen Lieferfristen können sich auch aufgrund verspäteter und/oder geänderter Bestellungen des Kunden ändern. Teillieferungen und vorzeitige Lieferungen seitens AGT Gun Trade GmbH sind zulässig, wobei jede Teillieferung gesondert in Rechnungen gestellt werden kann. Weiters wird hingewiesen, das Lieferung und Transport aus Sicherheitsgründen, sofern nichts anderes vereinbart, von der AGT Gun Trade GmbH organisiert wird und das die Transportkosten zu Lasten des Kunden ergehen und ihm gesondert in Rechnung gestellt wird. Unverzüglich nach der Übergabe hat der Kunde die Ware mit der in den § 377,378 HGB vorgeschriebenen Sorgfalt zu untersuchen. Dabei festgestellte Störungen sind der AGT Gun Trade GmbH unverzüglich, unter Angabe von Art und Umfang der Störung, anzuzeigen.
          ...
          4. Gerichtsstand und Erfüllungsort ist bei Streitigkeiten der Hauptsitz der AGT Gun Trade GmbH. 5. Es gilt das Recht Österreichs unter Ausschluss der Bestimmung des Übereinkommens der Vereinten Nationen über Verträge des Internationalen Warenverkauf. 6. Der Gerichtsstand ist das Landesgericht in Klagenfurt am Wörthersee.
